...
public class TestGenerico {
   ...
   public static final String RESET = "\u001B[0m";
    ...
    System.out.println("Busco elemento inexistente en arbol vacio con pertenece." +
        ...
        System.out.println("///Prueba de metodo frontera()///");
        System.out.println("Escribo la lista de la frontera del arbol vacio: " + a.frontera().toString());
        System.out.println("////////////////////////////////");
	...
	System.out.println("Busco el nivel de 3. Tiene que dar " + sOk+" --> "  + (((int) a.nivel(3) == 2) ? sOk : sErr));
        ...
        System.out.println("///Prueba de metodo frontera()///");
        System.out.println("Escribo la lista de la frontera del arbol generico (deberia dar [7, 3, 12, 20, 22, 40, 45, 55]): " + a.frontera().toString());
        System.out.println("////////////////////////////////");
	...
	System.out.println("Altura de arbol clon:  "+b.altura());
        ...
        System.out.println("///Prueba de metodo frontera()///");
        System.out.println("Escribo la lista de la frontera del arbol generico clonado (deberia dar [7, 10, 12, 25, 27, 35, 22, 40, 45, 55]): " + b.frontera().toString());
        System.out.println("////////////////////////////////");
