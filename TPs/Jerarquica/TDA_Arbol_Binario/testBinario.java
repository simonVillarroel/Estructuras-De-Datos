...
public class testBinario {
   ...
   public static final String RESET = "\u001B[0m";
	...
	System.out.println("Altura de arbol vacio:  "+a.altura());
        ...
        System.out.println("Escribo la lista de la frontera del arbol binario vacio: " + a.frontera().toString());
	...
	System.out.println("Busco el nivel de 3. Tiene que dar " + sOk+" --> "  + (((int) a.nivel(3) == 2) ? sOk : sErr));
        ...
        System.out.println("Escribo la lista de la frontera del arbol binario (deberia dar [7, 10, 12, 20]): " + a.frontera().toString());
	...
	System.out.println("Altura de arbol clon:  "+b.altura());
        ...
        System.out.println("Escribo la lista de la frontera del arbol clonado (deberia dar [7, 10, 12, 35, 25]): " + b.frontera().toString());
        ...
        System.out.println("Busco ancestros de 12 deberia dar  15 - 10  : " + a.ancestros(12).toString());
